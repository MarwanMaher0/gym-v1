<template>
    <section class="schedule-section ptb-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8 text-center">
                    <div class="section-header" data-aos="fade-up" data-aos-duration="1200">
                        <h2 class="section-title">OUR <span>TRAINING</span> SCHEDULE</h2>
                        ...
                        <table class="custom-table bg-overlay-black bg_img"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="blank-data"></td>
                                    <td>
                                        <div class="dot">Jumping <span>10 am - 11 am</span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Monday</td>
                                ...
                                <tr>
                                    <td>Tuesday</td>
                                    <td class="blank-data"></td>
                                    <td class="active">Cycling <span>10 am - 11 am</span></td>
                                    <td class="blank-data"></td>
                                    <td>Cycling <span>10 am - 11 am</span></td>
                                    <td class="blank-data"></td>
                                </tr>
